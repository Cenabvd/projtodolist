    ...
    return{
        ...
        showToDoTools : function(){
            if(event.target.tagName === "DIV"){
                document.getElementById('todo-tools').classList.add('left-1')
            } 
        },
        hiddenToDoTools: function() {
            if (event.target.tagName !== "DIV") {
                document.getElementById('todo-tools').classList.remove('left-1');   
            }
        }
    }
})();
