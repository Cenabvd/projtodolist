    ...
    return{
        ...
        showToDoTools : function(){
            if(event.target.tagName === "DIV"){
                document.getElementById('tools-parent').classList.add('lg:left-1')
            } 
        },
        hiddenToDoTools: function() {
            if (event.target.tagName !== "DIV") {
                document.getElementById('tools-parent').classList.remove('lg:left-1');   
            }
        },
        // delete btn
        DeleteBtn : function(){
            if (event.target.tagName === "SVG") {
                 alert('hala la lay la lay ebi')
            }
